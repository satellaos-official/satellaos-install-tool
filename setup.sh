...
chmod +x "$HOME/satellaos-install-tool/lightdm/lightdm.sh"
"$HOME/satellaos-install-tool/lightdm/lightdm.sh"
...
chmod +x "$HOME/satellaos-install-tool/drivers/touchpad setup.sh"
"$HOME/satellaos-install-tool/drivers/touchpad setup.sh"

# --------------------------------------------------
# 13 - Bluetooth setup
# --------------------------------------------------
echo "13 - Installing and configuring Bluetooth..."
chmod +x "$HOME/satellaos-install-tool/drivers/bluetooth setup.sh"
"$HOME/satellaos-install-tool/drivers/bluetooth setup.sh"

# --------------------------------------------------
# 14 - AMD graphics stack setup (optional)
# --------------------------------------------------
echo "14 - Running AMD graphics setup (optional)..."
chmod +x "$HOME/satellaos-install-tool/drivers/graphics amd setup.sh"
"$HOME/satellaos-install-tool/drivers/graphics amd setup.sh"

# --------------------------------------------------
# 15 - Intel graphics stack setup (optional)
# --------------------------------------------------
echo "15 - Running Intel graphics setup (optional)..."
chmod +x "$HOME/satellaos-install-tool/drivers/graphics intel setup.sh"
"$HOME/satellaos-install-tool/drivers/graphics intel setup.sh"

# --------------------------------------------------
# 16 - Apply system configuration files
# --------------------------------------------------
echo "16 - Applying system configuration..."
chmod +x "$HOME/satellaos-install-tool/config/config.sh"
"$HOME/satellaos-install-tool/config/config.sh"
...
chmod +x "$HOME/satellaos-install-tool/fonts-v4.sh"
"$HOME/satellaos-install-tool/fonts/fonts-v4.sh"

# --------------------------------------------------
# 23 - Program install
# --------------------------------------------------
echo "23 - Programs is installing..."
chmod +x "$HOME/satellaos-install-tool/satellaos-program-installer-tool-5.2.0.sh"
"$HOME/satellaos-install-tool/satellaos-program-installer-tool-5.2.0.sh"
